module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    copy: {
      scripts: {
        ...
        rename: function(dest, src) {
          return dest + src.replace('scripts','online-badge');
        }
      }
    },
    concat: {
    ...
    uglify: {
      dist: {
        files: {
          'dist/online-badge.template.min.js': ['.tmp/scripts.template.js'],
          'dist/online-badge.min.js': ['.tmp/scripts.js']
        }
      }
    },
    html2js: {
      dist: {
        ...
        module: 'eha.online-badge.template',
        options: {
